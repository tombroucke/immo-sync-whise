 ...
 *
 * ADB\ImmoSyncWhise\Vendor\Monolog supports the logging levels described by RFC 5424 {@see https://datatracker.ietf.org/doc/html/rfc5424}
 ...
 *
 * - Use ->getName() to get the standard ADB\ImmoSyncWhise\Vendor\Monolog name which is full uppercased (e.g. "DEBUG")
...
enum Level: int
{
     ...
     *
     * @phpstan-return \ADB\ImmoSyncWhise\Vendor\Psr\Log\LogLevel::*
     */
