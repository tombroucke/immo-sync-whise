...
class LogstashFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string the key for 'extra' fields from the ADB\ImmoSyncWhise\Vendor\Monolog record
     */
    protected string $extraKey;

    /**
     * @var string the key for 'context' fields from the ADB\ImmoSyncWhise\Vendor\Monolog record
     */
