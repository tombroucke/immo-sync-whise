...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string a prefix for 'extra' fields from the ADB\ImmoSyncWhise\Vendor\Monolog record (optional)
     */
    protected string $extraPrefix;

    /**
     * @var string a prefix for 'context' fields from the ADB\ImmoSyncWhise\Vendor\Monolog record (optional)
     */
    ...
    /**
     * Translates ADB\ImmoSyncWhise\Vendor\Monolog log levels to Graylog2 log priorities.
     */
    ...
    public function __construct(?string $systemName = null, ?string $extraPrefix = null, string $contextPrefix = 'ctxt_', ?int $maxLength = null)
    {
        if (!class_exists(Message::class)) {
            throw new \RuntimeException('Composer package graylog2/gelf-php is required to use ADB\ImmoSyncWhise\Vendor\Monolog\'s GelfMessageFormatter');
        }
