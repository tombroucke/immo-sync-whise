...
/**
 * ADB\ImmoSyncWhise\Vendor\Monolog error handler
 *
...
class ErrorHandler
{
     ...
     * @param int              $reservedMemorySize Amount of KBs to reserve in memory so that it can be freed when handling fatal errors giving ADB\ImmoSyncWhise\Vendor\Monolog some room in memory to get its job done
     * @return $this
     */
