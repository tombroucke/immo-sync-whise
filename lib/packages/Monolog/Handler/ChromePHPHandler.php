...
use ADB\ImmoSyncWhise\Vendor\Monolog\Formatter\ChromePHPFormatter;
...
class ChromePHPHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(int|string|Level $level = Level::Debug, bool $bubble = true)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use ADB\ImmoSyncWhise\Vendor\Monolog\'s ChromePHPHandler');
        }
    }
