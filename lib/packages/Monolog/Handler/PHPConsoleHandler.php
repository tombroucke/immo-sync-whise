...
use ADB\ImmoSyncWhise\Vendor\Monolog\Formatter\LineFormatter;
...
/**
 * ADB\ImmoSyncWhise\Vendor\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \ADB\ImmoSyncWhise\Vendor\Monolog\Logger('all', array(new \ADB\ImmoSyncWhise\Vendor\Monolog\Handler\PHPConsoleHandler()));
 *      \ADB\ImmoSyncWhise\Vendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 * }
 *
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in ADB\ImmoSyncWhise\Vendor\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classesPartialsTraceIgnore' => ['ADB\ImmoSyncWhise\Vendor\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \ADB\ImmoSyncWhise\Vendor\Monolog\Handler\PHPConsoleHandler::$options for more details
